...
import "../../../lib/@uniswap/v3-periphery/contracts/interfaces/IQuoter.sol";
...
contract UniswapV3Seller is ITokenSeller {
    ...
    function isZeroToken1() public view returns (bool) {
        return token1 == address(0);
    }
    ...
    function getSwapParams(uint256 amount) public view returns (ISwapRouter.ExactInputParams memory) {
